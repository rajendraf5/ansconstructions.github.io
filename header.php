...
<html lang="en">
  <head>
      ...
      <title>ANS Constructions Private Limited, Best Constructions Company in India.</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark"> 
            <div class="container sh-header">
              <a class="navbar-brand logo" href="index.php"><img src="images/logo.png" alt="Logo" ></a>
                ...
                <div class="collapse navbar-collapse nav_3" id="navbarResponsive">
                  <ul class="navbar-nav ml-auto nav-menu menu-link">
